...
Public Class PercheDonare
    ...
    Private Sub PercheDonare_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            Dim pathRoot = UtilityContainer.GetRootPath(Context)
            Dim pathFileContent = pathRoot + "PercheDonare.html"
